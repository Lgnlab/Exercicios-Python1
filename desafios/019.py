...
class Livro:
    def __init__(self, titulo, paginas):
        ...
        print(f':book: [blue]Você acabou de abrir o livro "[red]{self.titulo}[/]" que tem [green]{self.total_paginas} páginas[/] no total. Você agora está na [yellow]página {self.pagina_atual}[/]')
